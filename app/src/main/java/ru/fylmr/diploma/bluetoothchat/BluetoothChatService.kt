...
class BluetoothChatService(private val handler: Handler) {
    ...
    private fun updateUserInterfaceTitle() {
        ...
        handler.obtainMessage(Constants.MESSAGE_STATE_CHANGE, mNewState, -1)
            .sendToTarget()
    }
    ...
    private inner class AcceptThread(secure: Boolean) : Thread() {
        ...
        init {
            ...
            mmServerSocket = tmp
            this@BluetoothChatService.state = STATE_LISTEN
        }
    }
    ...
    private inner class ConnectThread(private val mmDevice: BluetoothDevice, secure: Boolean) :
        ...
        init {
            ...
            mmSocket = tmp
            this@BluetoothChatService.state = STATE_CONNECTING
        }
    }
    ...
    private inner class ConnectedThread(socket: BluetoothSocket?, socketType: String) : Thread() {
        ...
        init {
            ...
            mmInStream = tmpIn
            mmOutStream = tmpOut
            this@BluetoothChatService.state = STATE_CONNECTED
        }
    }
