package ru.fylmr.diploma.crypto.primitives.modes;

import ru.fylmr.diploma.crypto.IntegrityException;
import ru.fylmr.diploma.crypto.primitives.BlockCipher;
...
public class CBCBlockCipher {
    ...
    public byte[] encrypt(byte[] iv, byte[] data) throws IntegrityException {
        ...
        System.arraycopy(iv, 0, currentIV, 0, blockSize);
        ...
        for (int i = 0; i < count; i++) {
            ...
            System.arraycopy(res, i * blockSize + 0, currentIV, 0, blockSize);
        }
