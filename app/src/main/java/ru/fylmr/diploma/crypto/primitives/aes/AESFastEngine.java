package ru.fylmr.diploma.crypto.primitives.aes;


import ru.fylmr.diploma.crypto.primitives.BlockCipher;
import ru.fylmr.diploma.crypto.primitives.util.Pack;
...
public class AESFastEngine
    ...
    */
    ...
    private int[][] decryptionKey = null;
    private int C0, C1, C2, C3;

    private static final int BLOCK_SIZE = 16;

    public AESFastEngine(byte[] key) {
