...
*/
    ...
    public static void ge_madd(ge_p1p1 r, GroupElemExtended p, ge_precomp q) {
        int[] t0 = new int[10];
//CONVERT #include "ge_madd.h"
        ...
        FieldElementAddition.fieldElementAddition(r.X, p.Y, p.X);

        /* qhasm: YmX1 = Y1-X1 */
        /* asm 1: fe_sub.fe_sub(>YmX1=fe#2,<Y1=fe#12,<X1=fe#11); */
        /* asm 2: fe_sub.fe_sub(>YmX1=r.Y,<Y1=p.Y,<X1=p.X); */
        FieldElementSubtraction.fieldElementSubtraction(r.Y, p.Y, p.X);
