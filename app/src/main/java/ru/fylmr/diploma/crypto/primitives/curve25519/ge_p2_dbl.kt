...
fun ge_p2_dbl(r: GECompleted, p: GEProjective) {
    ...
    /* asm 2: fe_add.fe_add(>A=r.Y,<X1=p.X,<Y1=p.Y); */feAddition(r.Y, p.X, p.Y)
    ...
    /* asm 2: fe_add.fe_add(>Y3=r.Y,<YY=r.Z,<XX=r.X); */feAddition(r.Y, r.Z, r.X)

    /* qhasm: Z3=YY-XX */
    /* asm 1: fe_sub.fe_sub(>Z3=fe#3,<YY=fe#3,<XX=fe#1); */
    /* asm 2: fe_sub.fe_sub(>Z3=r.Z,<YY=r.Z,<XX=r.X); */feSubtraction(r.Z, r.Z, r.X)

    /* qhasm: X3=AA-Y3 */
    /* asm 1: fe_sub.fe_sub(>X3=fe#1,<AA=fe#5,<Y3=fe#2); */
    /* asm 2: fe_sub.fe_sub(>X3=r.X,<AA=t0,<Y3=r.Y); */feSubtraction(r.X, t0, r.Y)

    /* qhasm: T3=B-Z3 */
    /* asm 1: fe_sub.fe_sub(>T3=fe#4,<B=fe#4,<Z3=fe#3); */
    /* asm 2: fe_sub.fe_sub(>T3=r.T,<B=r.T,<Z3=r.Z); */feSubtraction(r.T, r.T, r.Z)
