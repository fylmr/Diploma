...
public static void ge_msub(ge_p1p1 r, GroupElemExtended p, ge_precomp q)
{
  int[] t0 = new int[10];
...
FieldElementSubtraction.fieldElementSubtraction(r.Z,t0,r.T);

/* qhasm: T3 = D+C */
/* asm 1: fe_add.fe_add(>T3=fe#4,<D=fe#5,<C=fe#4); */
/* asm 2: fe_add.fe_add(>T3=r.T,<D=t0,<C=r.T); */
FieldElementAddition.fieldElementAddition(r.T,t0,r.T);
